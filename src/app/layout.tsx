  ...
  return (
    <html suppressHydrationWarning lang="es">
      <head>
        ...
        <meta
          name="description"
          content="Clases de canto personalizadas para todos los niveles en la ciudad de Buenos Aires. Aprende técnicas vocales y mejora tu voz con una profesora experimentada."
        />
        <meta
          name="keywords"
          content="clases de canto, técnica vocal, lecciones de canto, profesora de canto, canto para principiantes, entrenamiento vocal, clases de canto particulares, clases de canto caba"
        />
        ...
        <meta
          property="og:title"
          content="Clases de canto - Evangelina Pérez"
        />
        <meta
      ...
      <body
        className={`bg-[#FCFCFC] ${inter.className}`}
